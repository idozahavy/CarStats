...
│  (+ MetadataSheet) · recordings · settings  │
│  · manage_cars · comparison                 │
└──────────────────────┬──────────────────────┘
...
| State | ChangeNotifier providers wired at root: `ThemeProvider`, `SettingsProvider`, `LocaleProvider`, `RecordingEngine` | [lib/core/providers.dart](lib/core/providers.dart), [lib/main.dart](lib/main.dart) |
| i18n | ARB-based localization (en + he) generated by `flutter gen-l10n` | [lib/l10n/](lib/l10n/), [l10n.yaml](l10n.yaml) |
...
| Math | Gravity calibration, acceleration decomposition, heading auto-calibration, derived benchmark calculators | [lib/services/calibration_service.dart](lib/services/calibration_service.dart), [lib/services/benchmarks/](lib/services/benchmarks/) |
